				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown" id="header-notification">
						...
						<ul class="dropdown-menu notification">
							<li class="dropdown-title">
								<span><i class="fa fa-bell"></i> Disabled</span>
							</li>
							<!-- <li>
								<a href="#">
					...
					<li class="dropdown" id="header-message">
						...
						<ul class="dropdown-menu inbox">
							<li class="dropdown-title">
								<span><i class="fa fa-envelope-o"></i> Disabled</span>
					...
					<li class="dropdown" id="header-tasks">
						...
						<ul class="dropdown-menu tasks">
							<li class="dropdown-title">
								<span><i class="fa fa-check"></i> Disabled</span>
							</li>
							<!-- <li>
								<a href="#">
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub">
								...
								<i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">User Slot Management</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="/admin/exits"><span class="sub-menu-text">Exits</span></a></li>
								</ul>
							</li>
						</ul>
						<!-- /SIDEBAR MENU -->
